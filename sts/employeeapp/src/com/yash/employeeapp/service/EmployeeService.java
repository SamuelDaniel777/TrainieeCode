...
/*
 * EmployeeSevice methods and arraylist
 * 
 */
...
public interface EmployeeService {
		...
		void getEmpById(Integer id) throws ClassNotFoundException, IOException, InvalidId, NumberFormatException, InvalidString;
		List<Employee> getEmpByName(String name) throws ClassNotFoundException, IOException;
		List<Employee> getEmpByDepartment(String name) throws ClassNotFoundException, IOException;
		Employee getHighSalaryEmployee() throws ClassNotFoundException, IOException;
		List<Employee> getEmployeeByNameAndSalary(String name,double salary) throws ClassNotFoundException, IOException;
		void getDeptList() throws ClassNotFoundException, IOException;
