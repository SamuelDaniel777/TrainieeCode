...
public class EmployeeData  {
	...
	public static void searchEmployeeBy() throws NumberFormatException, IOException, ClassNotFoundException, InvalidId, InvalidString {
		System.out.println("=================================================================================");
		...
		if (m.find()==true) {
			...
			case 1:
				try {
					...
					throw new InvalidId("Invalid entry please use numbers");
				}
			...
			case 2:
				try {
					...
					throw new InvalidString(" Invalid Name ");
				}
